...
<div class="panelContent ohanah module <?php echo $params->get( 'moduleclass_sfx' ) ?>">
	...
	<form method="get" action="<?=@route('option=com_ohanah&view=events&layout=default')?>" id="filterForm" class="box short">
					...
					<div class="ohanah-filter-venue">
						<div class="dropdownWrapper" style="float:left; margin-right:10px">
							<div class="dropdown size4">
								...
								<?=@helper('com://admin/ohanah.template.helper.listbox.venues', array('name' => 'ohanah_venue_id', 'selected' => $selected, 'prompt' => 'OHANAH_VENUE', 'published' => 1)) ?>
							</div>
						</div>
					</div>
				<? endif ?>
					...
					<div class="ohanah-filter-category">
						<div class="dropdownWrapper" style="float:left; margin-right:10px">
							<div class="dropdown size4">
								...
								<?=@helper('com://admin/ohanah.template.helper.listbox.categories', array('name' => 'ohanah_category_id', 'selected' => $selected, 'prompt' => 'OHANAH_CATEGORY', 'published' => 1)) ?>
							</div>
						</div>
					</div>
				<? endif ?>
